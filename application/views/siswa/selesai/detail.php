...
<div class="content-wrapper">
    ...
    <div class="content-header animated fadeInUp faster">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1>Detail Pengajuan Siswa</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/dashboard') ?>">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/siswa/selesai') ?>">Selesai</a></li>
                            ...
                            <div class="card-footer p-0">
                                <table id="example1" class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($data->selesai_magang === null || $data->mulai_magang === null) { ?>
                                            <td>Belum di isi
                                            <?php } else { ?>
                                            <td>
                    ...
                    <div class="col-md-5">
                        <div class="card card-outline">
                            ...
                            <div class="card-body p-1">
                                <a href="<?= base_url('include/suratpengantar/' . $data->surat) ?>" target="_blank">
