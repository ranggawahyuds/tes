                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center" width="12%">
                                                    <a href="<?= base_url('admin/siswa/selesai/detail/' . $id) ?>" class="btn btn-sm btn-dark" title="Detail"><i class="fa fa-eye"></i> Detail</a>
                                                    <a href="<?= base_url('admin/siswa/selesai/edit/' . $id) ?>" class="btn btn-sm btn-primary" title="Edit"><i class="fa fa-edit"></i> Edit</a>
