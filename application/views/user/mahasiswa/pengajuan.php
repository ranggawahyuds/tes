            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card card-outline">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?= base_url('mahasiswa/pengajuan/update') ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>NIM</label>
                                    <input type="text" class="form-control" name="nim" placeholder="e.g. 12164440" value="<?= set_value('nim') ?>">
                                    <span class="text-red"><?= form_error('nim') ?></span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="universitas" placeholder="e.g. Bina Sarana Informatika" value="<?= set_value('universitas') ?>">
                                    <span class="text-red"><?= form_error('universitas') ?></span>
                                </div>

                                <div class="form-group">
                                    <label>Program Studi</label>
                                    <input type="text" class="form-control" name="program_studi" placeholder="e.g. Pertanian" value="<?= set_value('program_studi') ?>">
                                    <span class="text-red"><?= form_error('program_studi') ?></span>
                                </div>
