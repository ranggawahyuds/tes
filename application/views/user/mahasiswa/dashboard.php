<style>
td {
    max-width: 200px; /* Atur lebar maksimum sesuai kebutuhan Anda */
    overflow: hidden; /* Atur overflow agar isi yang terlalu lebar tidak keluar dari sel */
    text-overflow: ellipsis; /* Jika isi sel terlalu lebar, gunakan tanda elipsis (...) untuk menunjukkan bahwa ada lebih banyak teks yang tidak ditampilkan */
                ...
                <div class="col-md-3">
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <form method="POST" action="<?= base_url('mahasiswa/dashboard/update_foto') ?>" enctype="multipart/form-data">
                                ...
                                <?php if ($data_photo->photo == NULL) { ?>
                                    ...
                                    <button type="submit" class="btn btn-block btn-primary"><b>Update Foto</b></button>
                                <?php } else { ?>
                            ...
                            <div class=" text-center mt-3">
                                <a href="<?= base_url('mahasiswa/user/ubah_password') ?>" class="btn btn-block btn-primary"> <b>ubah password</b> </a>
                            </div>
                        </div>
                    </div>
                </div>
