                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="<?= base_url('admin/mahasiswa/pengajuan/detail/' . $id) ?>" class="btn btn-sm btn-dark" title="Detail">
                                                        <i class="fa fa-eye"></i> Detail
                                                    </a>
                                                    <a href="<?= base_url('admin/mahasiswa/pengajuan/edit/' . $id) ?>" class="btn btn-sm btn-primary" title="Edit">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>
                                                    <a href="<?= base_url('admin/mahasiswa/pengajuan/delete/'. $id)?>" class="btn btn-danger btn-sm hapus"><i class="fas fa-trash"></i> Hapus</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
...
<script type="text/javascript">
    $('.hapus').on('click', function(e) {
        ...
        Swal({
            title: 'PERINGATAN',
            text: "YAKIN INGIN HAPUS PENGAJUAN MAHASISWA INI ?",
            type: 'warning',
