                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center" width="15%">
                                                    ...
                                                    <a href="<?= base_url('admin/mahasiswa/status/detail/' . $id) ?>" class="btn btn-sm btn-dark" title="Detail"><i class="fa fa-eye"></i> Detail</a>

                                                    <a href="<?= base_url('admin/mahasiswa/status/edit/' . $id) ?>" class="btn btn-sm btn-primary" title="Edit"><i class="fa fa-edit"></i> Edit</a>
